...
Для простоты рассмотрим два товара, $x$ и $y$, как обычно, в $\mathbb{R}^2_{+}$. Обозначим цены этих двух товаров как $p, q$. Если бюджет агента составляет $I>0$, то **бюджетное ограничение** представляется полуплоскостью: 
